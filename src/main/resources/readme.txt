-- boot 쓰기 전에 설정 을 application.properties 에 필요한거 복붙해서 넣어야 돼 

예로 포트 변경하는거 한줄 넣어 놓을게 
...
# HTTP response compression ({sc-spring-boot-autoconfigure/web/GzipFilterProperties.java[GzipFilterProperties])
